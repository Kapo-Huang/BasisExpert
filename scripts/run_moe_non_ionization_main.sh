...
CONFIG_LIST_FILE="${SCRIPT_DIR}/run_moe_non_ionization_main.list"
...
while IFS= read -r raw || [[ -n "${raw}" ]]; do
    ...
    line="${line#./}"
    case "${line}" in
        configs/MoE-INR/bathymetry__*.yaml|configs/MoE-INR/combustion_40NH3_1__*.yaml|configs/MoE-INR/katrina__*.yaml) ;;
        *)
