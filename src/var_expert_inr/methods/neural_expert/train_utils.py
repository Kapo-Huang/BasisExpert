...
def log_losses_wandb(epoch, batch_idx, num_batches, log_dict, batch_size, weights):
    fraction_done = (batch_idx + 1) / num_batches
...
def log_string(out_str: str, log_file) -> None:
