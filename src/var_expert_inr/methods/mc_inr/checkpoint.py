...
CHECKPOINT_FORMAT = "mc_inr_inference_v1"
...
def validate_mc_checkpoint(
    ...
    *,
    ...
    if payload.get("format") != CHECKPOINT_FORMAT:
        raise ValueError(f"Unsupported MC-INR inference checkpoint: {payload.get('format')!r}")
    ...
    if payload.get("model_state") is None:
        raise ValueError("MC-INR inference checkpoint requires model_state")
